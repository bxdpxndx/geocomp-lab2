...
(function() {
  var Circle, Color, Point, Triangle, black, blue, gray, green, red, white;
  ...
  window.onload = function() {
    var canvas, circles, ctx, fps, mainloop, mouse, newButton, points, show_circles, supertriangle, triangles;
    fps = 30;
    ...
    window.onkeypress = function(e) {
      return console.log("you pressed " + String.fromCharCode(e.which));
    };
    newButton('clear', 'Clear', function() {
      points = [];
      return triangles = [];
    });
    return newButton('toggle-circles', 'Toggle Circles', function() {
